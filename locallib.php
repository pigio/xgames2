    ...
    foreach ($trackdata as $track) {
        ...
        switch ($element) {
            ...
            case 'cmi.total_time':
                ...
                break;
            case 'cmi.games.ScoreM0001':
                $usertrack->game +=  (float) sprintf('%2.2f', $track->value);
                //echo $usertrack->game;
                break;
            case 'cmi.games.ScoreM0101':
            case 'cmi.games.ScoreM0102': 
            case 'cmi.games.ScoreM0103': 
            case 'cmi.games.ScoreM0201a': 
            case 'cmi.games.ScoreM0201b': 
            case 'cmi.games.ScoreM0202': 
            case 'cmi.games.ScoreM0203': 
            case 'cmi.games.ScoreM0204a': 
            case 'cmi.games.ScoreM0204b': 
            case 'cmi.games.ScoreM0205a': 
            case 'cmi.games.ScoreM0205b': 
            case 'cmi.games.ScoreM0206a': 
            case 'cmi.games.ScoreM0206b': 
            case 'cmi.games.ScoreM0301a': 
            case 'cmi.games.ScoreM0301b': 
            case 'cmi.games.ScoreM0302': 
            case 'cmi.games.ScoreM0303': 
            case 'cmi.games.ScoreM0304': 
            case 'cmi.games.ScoreM0305a': 
            case 'cmi.games.ScoreM0305b': 
            case 'cmi.games.ScoreM0305c': 
            case 'cmi.games.ScoreM0305d': 
            case 'cmi.games.ScoreM0305e': 
            case 'cmi.games.ScoreM0306a': 
            case 'cmi.games.ScoreM0306b': 
            case 'cmi.games.ScoreM0307a': 
            case 'cmi.games.ScoreM0307b': 
            case 'cmi.games.ScoreM0307c': 
            case 'cmi.games.ScoreM04b': 
            case 'cmi.games.ScoreM04b': 
            case 'cmi.games.ScoreM04c': 
            case 'cmi.games.ScoreM04d': 
            case 'cmi.games.ScoreM04e': 
            case 'cmi.games.ScoreM04f': 
            case 'cmi.games.ScoreM04g':
                $usertrack->game +=  (float) sprintf('%2.2f', $track->value);
                //echo $usertrack->game;
                break;
        }
