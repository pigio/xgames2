...
function SCORMapi1_2(def, cmiobj, cmiint, cmistring256, cmistring4096, scormdebugging, scormauto, scormid, cfgwwwroot, sesskey,
    ...
    // Children lists
    cmi_children = 'core,suspend_data,launch_data,comments,objectives,student_data,student_preference,interactions,games';
    core_children = 'student_id,student_name,lesson_location,credit,lesson_status,entry,score,total_time,lesson_mode,exit,session_time';
    game_children = 'ScoreM0001,ScoreM0101,ScoreM0102,ScoreM0103,ScoreM0201a,ScoreM0201b,ScoreM0202,ScoreM0203,ScoreM0204a,ScoreM0204b,ScoreM0205a,ScoreM0205b,ScoreM0206a,ScoreM0206b,ScoreM0301a,ScoreM0301b,ScoreM0302,ScoreM0303,ScoreM0304,ScoreM0305a,ScoreM0305b,ScoreM0305c,ScoreM0305d,ScoreM0305e,ScoreM0306a,ScoreM0306b,ScoreM0307a,ScoreM0307b,ScoreM0307c,ScoreM04b,ScoreM04b,ScoreM04c,ScoreM04d,ScoreM04e,ScoreM04f,ScoreM04g';

    Scorechildren = 'raw,min,max';
    ...
    for(scoid in def){
        datamodel[scoid] = {
            ...
            'cmi.core.score._children':{'defaultvalue':Scorechildren, 'mod':'r', 'writeerror':'402'},
            'cmi.core.score.raw':{'defaultvalue':def[scoid]['cmi.core.score.raw'], 'format':CMIDecimal, 'range':Scorerange, 'mod':'rw', 'writeerror':'405'},
            'cmi.core.score.max':{'defaultvalue':def[scoid]['cmi.core.score.max'], 'format':CMIDecimal, 'range':Scorerange, 'mod':'rw', 'writeerror':'405'},
            'cmi.core.score.min':{'defaultvalue':def[scoid]['cmi.core.score.min'], 'format':CMIDecimal, 'range':Scorerange, 'mod':'rw', 'writeerror':'405'},
            ...
            //custom
            'cmi.games._children':{'defaultvalue':game_children, 'mod':'r', 'writeerror':'402'},
            'cmi.games.ScoreM0001':{'defaultvalue':def[scoid]['cmi.games.ScoreM0001'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0101':{'defaultvalue':def[scoid]['cmi.games.ScoreM0101'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0102':{'defaultvalue':def[scoid]['cmi.games.ScoreM0102'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0103':{'defaultvalue':def[scoid]['cmi.games.ScoreM0103'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0201a':{'defaultvalue':def[scoid]['cmi.games.ScoreM0201a'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0201b':{'defaultvalue':def[scoid]['cmi.games.ScoreM0201b'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0202':{'defaultvalue':def[scoid]['cmi.games.ScoreM0202'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0203':{'defaultvalue':def[scoid]['cmi.games.ScoreM0203'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0204a':{'defaultvalue':def[scoid]['cmi.games.ScoreM0204a'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0204b':{'defaultvalue':def[scoid]['cmi.games.ScoreM0204b'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0205a':{'defaultvalue':def[scoid]['cmi.games.ScoreM0205a'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0205b':{'defaultvalue':def[scoid]['cmi.games.ScoreM0205b'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0206a':{'defaultvalue':def[scoid]['cmi.games.ScoreM0206a'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0206b':{'defaultvalue':def[scoid]['cmi.games.ScoreM0206b'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0301a':{'defaultvalue':def[scoid]['cmi.games.ScoreM0301a'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0301b':{'defaultvalue':def[scoid]['cmi.games.ScoreM0301b'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0302':{'defaultvalue':def[scoid]['cmi.games.ScoreM0206a'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0303':{'defaultvalue':def[scoid]['cmi.games.ScoreM0303'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0304':{'defaultvalue':def[scoid]['cmi.games.ScoreM0304'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0305a':{'defaultvalue':def[scoid]['cmi.games.ScoreM0305a'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0305b':{'defaultvalue':def[scoid]['cmi.games.ScoreM0305b'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0305c':{'defaultvalue':def[scoid]['cmi.games.ScoreM0305c'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0305d':{'defaultvalue':def[scoid]['cmi.games.ScoreM0305d'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0305e':{'defaultvalue':def[scoid]['cmi.games.ScoreM0305e'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0306a':{'defaultvalue':def[scoid]['cmi.games.ScoreM0306a'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0306b':{'defaultvalue':def[scoid]['cmi.games.ScoreM0306b'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0307a':{'defaultvalue':def[scoid]['cmi.games.ScoreM0307a'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0307b':{'defaultvalue':def[scoid]['cmi.games.ScoreM0307b'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM0307c':{'defaultvalue':def[scoid]['cmi.games.ScoreM0307c'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM04b':{'defaultvalue':def[scoid]['cmi.games.ScoreM04b'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM04b':{'defaultvalue':def[scoid]['cmi.games.ScoreM04b'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM04c':{'defaultvalue':def[scoid]['cmi.games.ScoreM04c'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM04d':{'defaultvalue':def[scoid]['cmi.games.ScoreM04d'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM04e':{'defaultvalue':def[scoid]['cmi.games.ScoreeM04e'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM04f':{'defaultvalue':def[scoid]['cmi.games.ScoreM04f'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            'cmi.games.ScoreM04g':{'defaultvalue':def[scoid]['cmi.games.ScoreM04g'], 'format':CMIDecimal, 'range':games_range, 'mod':'rw', 'writeerror':'405'},
            ...
            'cmi.objectives.n.score.raw':{'defaultvalue':'', 'pattern':CMIIndex, 'format':CMIDecimal, 'range':Scorerange, 'mod':'rw', 'writeerror':'405'},
            'cmi.objectives.n.score.min':{'defaultvalue':'', 'pattern':CMIIndex, 'format':CMIDecimal, 'range':Scorerange, 'mod':'rw', 'writeerror':'405'},
            'cmi.objectives.n.score.max':{'defaultvalue':'', 'pattern':CMIIndex, 'format':CMIDecimal, 'range':Scorerange, 'mod':'rw', 'writeerror':'405'},
                                ...
                                for (i = 1; i < elementIndexes.length - 1; i++) {
                                    ...
                                    if ((typeof eval(subelement)) == "undefined") {
                                        ...
                                        if (subelement.substr(0,14) == 'cmi.objectives') {
                                            ...
                                            eval(subelement + '.score._children = Scorechildren;');
